...
export function TuitionCard({ tuition, action }: { tuition: TuitionPublic; action?: React.ReactNode }) {
  ...
  return (
    <Card className={`motion-card h-full transition-all hover:shadow-md ${featured ? "border-amber-300 bg-gradient-to-br from-amber-50 to-white shadow-md ring-1 ring-amber-200 dark:border-amber-700 dark:from-amber-950/30 dark:to-slate-800 dark:ring-amber-900" : ""}`}>
