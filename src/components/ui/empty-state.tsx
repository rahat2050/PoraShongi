...
export function EmptyState({
  ...
  return (
    ...
    >
      {icon && (
        <div className="motion-float mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-slate-300">
          {icon}
        </div>
      )}
