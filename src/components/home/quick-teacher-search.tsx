...
export function QuickTeacherSearch() {
  return (
    <form
      action="/teachers"
      method="get"
      className="motion-reveal mx-auto mt-12 max-w-6xl rounded-[1.75rem] border border-white/80 bg-white/95 p-2.5 text-left shadow-[0_28px_80px_-38px_rgba(4,47,46,.55)] sm:p-3 dark:border-slate-700/80 dark:bg-slate-900/95"
