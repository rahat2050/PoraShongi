        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_.95fr] lg:gap-16">
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              <Link href="/teachers" className={buttonStyles({ size: "lg", className: "h-13 rounded-xl px-7 shadow-lg shadow-brand-900/15" })}>
                শিক্ষক খুঁজুন <ArrowRight className="h-4 w-4" aria-hidden />
              </Link>
              <Link href="/tuitions" className={buttonStyles({ variant: "outline", size: "lg", className: "h-13 rounded-xl border-slate-300 bg-white/80 px-7 backdrop-blur dark:bg-slate-900/70" })}>
                টিউশন সুযোগ দেখুন
              </Link>
            </div>
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1 text-left">
                        <span className="flex items-center gap-2">
                          ...
                          <span className="text-[10px] text-slate-400">0{index + 1}</span>
                        </span>
                        <span className="mt-0.5 block text-sm font-medium text-slate-700 dark:text-slate-200">{item.description}</span>
                      </span>
                      <ArrowUpRight className="h-4 w-4 shrink-0 text-slate-400 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-brand-700 dark:group-hover:text-brand-300" aria-hidden />
                    </Link>
                  );
                })}
              </div>

              <div className="mx-2 mb-2 mt-1 flex items-center justify-between rounded-2xl bg-slate-950 px-4 py-3 text-left text-white dark:bg-brand-950">
                <div>
