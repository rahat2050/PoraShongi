...
export const metadata: Metadata = { title: "My tuitions" };
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">My tuitions</h1>
          <p className="mt-1 text-slate-500">
            {tuitions.length} tuition{tuitions.length === 1 ? "" : "s"}
          </p>
        </div>
      ...
      <div className="mt-6 space-y-4">
        {tuitions.length === 0 ? (
          <EmptyState
            ...
            description="Create a tuition requirement to start connecting with teachers."
            action={
              <Link href="/dashboard/tuitions/new" className={buttonStyles()}>
                Create tuition
              </Link>
