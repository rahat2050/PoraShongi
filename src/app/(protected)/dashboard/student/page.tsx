      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-slate-500">
            Manage your tuition requirements and requests.
          </p>
        </div>
        <Badge variant="brand">
            ...
            <div className="mt-4 divide-y divide-slate-100">
              {tuitionList.length === 0 ? (
                <EmptyState
                  ...
                  description="Create your first tuition requirement to start finding teachers."
                />
              ) : (
            ...
            <div className="mt-2 divide-y divide-slate-100">
              {sentRows.length === 0 ? (
                <EmptyState
                  ...
                  description="Find a teacher and send your first tuition request."
                />
              ) : (
                sentRows.map((row) => (
